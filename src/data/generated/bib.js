define({ entries : {
    ...
    "craven1993b": {
        ...
        "type": "inproceedings",
        "url": "https://books.google.co.ma/books?hl",
        "year": "1993"
    },
    "craven1994": {
        "%keywords": "",
    ...
    "goh1993": {
        ...
        "keywords": "type: neural_nets, knowledge_acquisition, financial_data_processing, sensitivity_analysis, computational_linguistics, semantic_networks",
        "pages": "1031-1034",
    ...
    "hayward1996": {
        "%keywords": "",
        "abstract": "Any symbolic representation of how a neural network decides on a particular classification is important, not only for user acceptance but also for rule refinement and network learning. This paper describes a decompositional rule extraction technique which generates rules governing the firing of individual nodes in a feedforward neural network. The technique employs heuristics to reduce the complexity in searching for rules which explain the behaviour of a neural network trained with sparsely coded data. The hidden and output units within the constructed networks are considered to represent distinct rules which govern the classification of patterns. A symbolic representation of the complete network can be gained from aggregation of these rules. Since the algorithm is not constrained to a particular network architecture, we focus on a comparison of the rule sets gained from networks constructed using the Cascade 2 algorithm and multi-layer perceptrons trained using backpropagation. The specific networks of interest are those trained to recognise if simple fixed length sentences are grammatically correct.",
        "address": "Berlin, Heidelberg",
    ...
    "kim200": {
        ...
        "editor": "Arikawa, Setsuo and Morishita, Shinichi",
    ...
    "lofstrom2004": {
        ...
        "address": "Berlin, Heidelberg",
        "author": "L{\\\"o}fstr{\\\"o}m, Tuve and Johansson, Ulf and Niklasson, Lars",
    ...
    "palade2001": {
        ...
        "address": "Berlin, Heidelberg",
        "author": "Palade, Vasile and Neagu, Daniel-Ciprian and Patton, Ron J.",
    ...
    "schmitz1999": {
        ...
        "keywords": "type: decision_trees, hybrid_systems, induction, neural_networks, rule_extraction, sensitivity_analysis",
        "number": "6",
        "pages": "1392-1401",
    ...
    "setiono1997a": {
        ...
        "issn": "0925-2312",
        "journal": "Neurocomputing",
        "keywords": "Rule extraction, Oblique-rule, Pruning, Discretization type: rule_extraction, oblique-rule, pruning, discretization",
        "number": "1",
        "pages": "1-24",
    ...
    "thrun1993": {
        ...
        "keywords": "type:machine_learning, artificial_neural_networks, rule_extraction, validity_interval analysis, symbolic_and_subsymbolic_representations",
        "publisher": "University of Bonn, Institut fur Informatik III Citeseer",
    ...
    "wu2018": {
        ...
        "type": "inproceedings",
        "url": "https://ojs.aaai.org/index.php/AAAI/article/view/11501 keywords{",
        "volume": "32",
        "year": "2018"
    },
    "yedjour2018": {
